...
public class DistancesBetweenCities {
    ...
    public static void main(String[] args) {
        ...
        //Search for closest city to Alken
        City closestCity = DistanceUtil.findClosest(cities, Alken);
        System.out.println("The closest city to Alken is " +
                closestCity.getName() +
                " with a distance of " +
                closestCity.distance(Alken) + "km.");
